...
export default function MonthlyReport() {
  ...
  return (
    <div className="container">
      <h1 className="page-heading">Monthly Attendance Report</h1>
      <p className="page-subheading">Register-style view — present days show the running attendance count, absent shows "A".</p>
